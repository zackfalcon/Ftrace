...
static syscall_t	table[330] =
{
	...
	{23, "select", 5, NUM,
	NUM, FD_SET_P, FD_SET_P, FD_SET_P, STRUCT_TIMEVAL_P, 0},
	...
	{78, "getdents", 3, NUM,
	UNSIGNED, STRUCT_LINUX_DIRENT_P, UNSIGNED, 0, 0, 0},
	...
	{101, "ptrace", 4, NUM,
	ENUM_____REQUEST, NUM, VOID_P, VOID_P, 0, 0},
	...
	{132, "utime", 2, NUM,
	STRING, CONST_STRUCT_UTIMBUF_P, 0, 0, 0, 0},
	...
	{142, "sched_setparam", 2, NUM,
	NUM, CONST_STRUCT_SCHED_PARAM_P, 0, 0, 0, 0},
	{143, "sched_getparam", 2, NUM,
	NUM, STRUCT_SCHED_PARAM_P, 0, 0, 0, 0},
	{144, "sched_setscheduler", 3, NUM,
	...
	{148, "sched_rr_get_interval", 2, NUM,
	NUM, STRUCT_TIMESPEC_P_, 0, 0, 0, 0},
	...
	{157, "prctl", 5, NUM,
	NUM, UNSIGNED, UNSIGNED, UNSIGNED, UNSIGNED, 0},
	...
	{164, "settimeofday", 2, NUM,
	CONST_STRUCT_TIMEVAL_P, CONST_STRUCT_TIMEZONE_P, 0, 0, 0, 0},
	{165, "mount", 5, NUM,
	STRING, STRING, STRING, UNSIGNED, CONST_VOID_P, 0},
	...
	{188, "setxattr", 5, NUM,
	STRING, STRING, CONST_VOID_P, NUM, NUM, 0},
	{189, "lsetxattr", 5, NUM,
	STRING, STRING, CONST_VOID_P, NUM, NUM, 0},
	{190, "fsetxattr", 5, NUM,
	NUM, STRING, CONST_VOID_P, NUM, NUM, 0},
	{191, "getxattr", 4, NUM,
	STRING, STRING, VOID_P, NUM, 0, 0},
	{192, "lgetxattr", 4, NUM,
	STRING, STRING, VOID_P, NUM, 0, 0},
	{193, "fgetxattr", 4, NUM,
	NUM, STRING, VOID_P, NUM, 0, 0},
	{194, "listxattr", 3, NUM,
	STRING, STRING, NUM, 0, 0, 0},
	{195, "llistxattr", 3, NUM,
	STRING, STRING, NUM, 0, 0, 0},
	{196, "flistxattr", 3, NUM, NUM, STRING, NUM, 0, 0, 0},
	{197, "removexattr", 2, NUM,
	STRING, STRING, 0, 0, 0, 0},
	{198, "lremovexattr", 2, NUM,
	STRING, STRING, 0, 0, 0, 0},
	...
	{203, "sched_setaffinity", 3, NUM,
	NUM, NUM, CONST_CPU_SET_T_P, 0, 0, 0},
	{204, "sched_getaffinity", 3, NUM,
	NUM, NUM, CPU_SET_T_P, 0, 0, 0},
	...
	{208, "io_getevents", 5, NUM,
	AIO_CONTEXT_T, NUM, NUM, STRUCT_IO_EVENT_P, STRUCT_TIMESPEC_P, 0},
	{209, "io_submit", 3, NUM,
	AIO_CONTEXT_T, NUM, STRUCT_IOCB_P, 0, 0, 0},
	{210, "io_cancel", 3, NUM,
	...
	{254, "inotify_add_watch", 3, NUM,
	NUM, STRING, UNUM32_T, 0, 0, 0},
	{255, "inotify_rm_watch", 2, NUM, NUM, NUM, 0, 0, 0, 0},
	{256, "migrate_pages", 4, NUM,
	...
	{261, "futimesat", 3, NUM,
	NUM, STRING, CONST_STRUCT_TIMEVAL, 0, 0, 0},
	{262, "newfstatat", 6, 0, 0, 0, 0, 0, 0, 0},
	{263, "unlinkat", 3, NUM, NUM, STRING, NUM, 0, 0, 0},
	{264, "renameat", 4, NUM, NUM,
	STRING, NUM, STRING, 0, 0},
	{265, "linkat", 5, NUM, NUM,
	STRING, NUM, STRING, NUM, 0},
	{266, "symlinkat", 3, NUM, STRING, NUM, STRING, 0, 0, 0},
	{267, "readlinkat", 4, NUM,
	NUM, STRING, STRING, NUM, 0, 0},
	{268, "fchmodat", 4, NUM, NUM, STRING, MODE_T, NUM, 0, 0},
	{269, "faccessat", 4, NUM, NUM, STRING, NUM, NUM, 0, 0},
	{270, "pselect6", 6, 0, 0, 0, 0, 0, 0, 0},
	{271, "ppoll", 4, NUM,
	STRUCT_POLLFD_P, UNSIGNED, CONST_STRUCT_TIMESPEC_P,
	CONST_SIGSET_T_P, 0, 0},
	{272, "unshare", 1, NUM, NUM, 0, 0, 0, 0, 0},
	{273, "set_robust_list", 2, NUM,
	STRUCT_ROBUST_LIST_HEAD_P, NUM, 0, 0, 0, 0},
	{274, "get_robust_list", 3, NUM,
	NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM_P, 0, 0, 0},
	{275, "splice", 6, NUM,
	NUM, LNUM_P, NUM, LNUM_P, NUM, UNSIGNED},
	{276, "tee", 4, NUM, NUM, NUM, NUM, UNSIGNED, 0, 0},
	{277, "sync_file_range", 4, NUM,
	NUM, OFF64_T, OFF64_T, UNSIGNED, 0, 0},
	{278, "vmsplice", 4, NUM,
	NUM, CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED, 0, 0},
	{279, "move_pages", 6, NUM,
	NUM, UNSIGNED, VOID_P, CONST_NUM_P, NUM_P, NUM},
	{280, "utimensat", 4, NUM,
	NUM, STRING, CONST_STRUCT_TIMESPEC, NUM, 0, 0},
	{281, "epoll_pwait", 5, NUM,
	...
	{286, "timerfd_settime", 4, NUM,
	NUM, NUM, CONST_STRUCT_ITIMERSPEC_P, STRUCT_ITIMERSPEC_P, 0, 0},
	{287, "timerfd_gettime", 2, NUM,
	NUM, STRUCT_ITIMERSPEC_P, 0, 0, 0, 0},
	{288, "accept4", 4, NUM,
	NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, NUM, 0, 0},
	...
	{295, "preadv", 4, NUM,
	NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, 0, 0},
	{296, "pwritev", 4, NUM,
	NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, 0, 0},
	{297, "rt_tgsigqueueinfo", 6, 0, 0, 0, 0, 0, 0, 0},
	{298, "perf_event_open", 5, NUM,
	STRUCT_PERF_EVENT_ATTR_P, NUM, NUM, NUM, UNSIGNED, 0},
	{299, "recvmmsg", 5, NUM,
	NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED, STRUCT_TIMESPEC_P, 0},
	{300, "fanotify_init", 2, NUM,
	UNSIGNED, UNSIGNED, 0, 0, 0, 0},
	{301, "fanotify_mark", 5, NUM,
	NUM, UNSIGNED, UNUM64_T, NUM, STRING, 0},
	{302, "prlimit64", 6, 0, 0, 0, 0, 0, 0, 0},
	{303, "name_to_handle_at", 5, NUM,
	NUM, STRING, STRUCT_FILE_HANDLE_P, NUM_P, NUM, 0},
	{304, "open_by_handle_at", 3, NUM,
	NUM, STRUCT_FILE_HANDLE_P, NUM, 0, 0, 0},
	{305, "clock_adjtime", 6, 0, 0, 0, 0, 0, 0, 0},
	{306, "syncfs", 1, NUM, NUM, 0, 0, 0, 0, 0},
	{307, "sendmmsg", 4, NUM,
	NUM, STRUCT_MMSGHDR_P, UNSIGNED, UNSIGNED, 0, 0},
	{308, "setns", 2, NUM, NUM, NUM, 0, 0, 0, 0},
	{309, "getcpu", 3, NUM,
	UNSIGNED_P, UNSIGNED_P, STRUCT__CACHE_P, 0, 0, 0},
	{310, "process_vm_readv", 6, NUM, NUM, CONST_STRUCT_IOVEC_P,
	UNSIGNED, CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED},
	{311, "process_vm_writev", 6, NUM, NUM, CONST_STRUCT_IOVEC_P,
	UNSIGNED, CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED},
	{312, "kcmp", 5, NUM,
	NUM, NUM, NUM, UNSIGNED, UNSIGNED, 0},
	{313, "finit_module", 3, NUM, NUM, STRING, NUM, 0, 0, 0},
	{314, "sched_setattr", 3, NUM,
	NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, 0, 0, 0},
	{315, "sched_getattr", 4, NUM,
	NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, UNSIGNED, 0, 0},
	{316, "renameat2", 5, NUM,
	NUM, STRING, NUM, STRING, UNSIGNED, 0},
	{317, "seccomp", 3, NUM,
	UNSIGNED, UNSIGNED, VOID_P, 0, 0, 0},
	{318, "getrandom", 3, NUM, VOID_P, NUM, UNSIGNED, 0, 0, 0},
	{319, "memfd_create", 2, NUM,
	STRING, UNSIGNED, 0, 0, 0, 0},
	{320, "kexec_file_load", 5, NUM,
	NUM, NUM, UNSIGNED, STRING, UNSIGNED, 0},
	{321, "bpf", 3, NUM, NUM, UNION__ATTR_P, UNSIGNED, 0, 0, 0},
	{322, "execveat", 5, NUM,
	NUM, STRING, STRING, STRING, NUM, 0},
	{323, "userfaultfd", 6, 0, 0, 0, 0, 0, 0, 0},
	{324, "membarrier", 2, NUM, NUM, NUM, 0, 0, 0, 0},
	{325, "mlock2", 3, NUM, CONST_VOID_P, NUM, NUM, 0, 0, 0},
	{326, "copy_file_range", 6, NUM,
	NUM, LNUM_P, NUM, LNUM_P, NUM, UNSIGNED},
	{327, "preadv2", 5, NUM,
	NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, NUM, 0},
	{328, "pwritev2", 5, NUM,
	NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, NUM, 0},
